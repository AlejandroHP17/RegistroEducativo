...
class RegisterUseCaseImp(
    ...
    private fun handleResponse(error: FailureService): ModelState<List<String>?, String> {
        return when(error) {
            ...
            is FailureService.Unauthorized -> ErrorState(ModelCodeError.ERROR_VALIDATION_REGISTER_USER)
            is FailureService.NotFound -> ErrorStateUser(ModelCodeError.ERROR_VALIDATION_REGISTER_INFO)
