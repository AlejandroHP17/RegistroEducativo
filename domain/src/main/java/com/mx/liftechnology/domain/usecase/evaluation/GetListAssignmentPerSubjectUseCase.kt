...
import com.mx.liftechnology.core.network.apiCall.schoolCycle.RequestGetPercentSubjectId
...
class GetListAssignmentPerSubjectUseCase (
     ...
     */
    private fun handleResponse(error: NetworkError): ResultModel<List<ModelFormatAssignment>?, String?> {
        return when(error) {
