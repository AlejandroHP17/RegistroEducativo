...
interface ValidateFieldsSubjectUseCase {
    ...
    fun validateListJobs(listJobs: MutableList<ModelFormatSubject>?): ModelState<String, String>
}
...
class ValidateFieldsSubjectUseCaseImp : ValidateFieldsSubjectUseCase {
     ...
     * @since 1.0.0
     * */
    override fun validateListJobs(listJobs: MutableList<ModelFormatSubject>?): ModelState<String, String> {
        return when{
    ...
    private fun validPercent(listJobs: MutableList<ModelFormatSubject>?) =
        listJobs?.let { jobs ->
