package com.mx.liftechnology.core.network.apiCall.flowMain.partial
...
fun interface GetListPartialApiCall {
     ...
     * @return Una respuesta de Retrofit que contiene un [com.mx.liftechnology.core.model.ResponseGeneric] con una lista de [ResponseGetPartial].
     */
