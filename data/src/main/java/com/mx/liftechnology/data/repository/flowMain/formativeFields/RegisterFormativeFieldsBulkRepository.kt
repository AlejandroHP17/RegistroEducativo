...
fun interface RegisterFormativeFieldsBulkRepository{
     ...
     */
    suspend fun executeRegisterFormativeFieldsBulk(request : RequestRegisterFormativeFields)
    : ModelResult<ModelFormativeFieldsData, NetworkError>
}
...
class RegisterFormativeFieldsBulkRepositoryImpl(
    ...
    override suspend fun executeRegisterFormativeFieldsBulk(
        request : RequestRegisterFormativeFields
    ): ModelResult<ModelFormativeFieldsData, NetworkError> {
        return try {
