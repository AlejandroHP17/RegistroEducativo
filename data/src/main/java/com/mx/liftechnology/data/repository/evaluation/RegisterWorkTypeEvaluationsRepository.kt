...
fun interface RegisterWorkTypeEvaluationsRepository{
    suspend fun executeRegisterWorkTyperEvaluations(request:RequestWorkTypeEvaluations) : ModelResult<Boolean, NetworkError>
}
class RegisterWorkTypeEvaluationsRepositoryImpl (
    ...
    override suspend fun executeRegisterWorkTyperEvaluations(request: RequestWorkTypeEvaluations): ModelResult<Boolean, NetworkError> {
        return try {
